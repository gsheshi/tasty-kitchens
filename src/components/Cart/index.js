...
class Cart extends Component {
  ...
  componentDidMount() {
    ...
    if (parseCartData === null || parseCartData.length === 0) {
      ...
      const totalCartAmount = parseCartData.reduce(
        (accumulator, eachItem) =>
          accumulator + eachItem.cost * eachItem.quantity,
        0,
      )
  ...
  render() {
    ...
    return cartStatus && totalCartAmount > 0 ? (
      !orderStatus ? (
        <div>
          <Header />
            ...
            <div className="cart-responsive-container">
              ...
              <div className="total-cart-amount-container">
                ...
                <p className="total-order-amount">
                  ₹<span testid="total-price">{totalCartAmount}</span>
                </p>
              </div>
